    ...
    <>
      ...
      <div className="w-full md:max-w-7xl flex md:justify-end md:mx-auto">
        <div
          ...
          } md:flex z-50 fixed md:absolute w-full md:w-auto h-full md:h-auto bg-gray-100 text-neutral-700 dark:text-neutral-300 dark:bg-black md:mt-10 md:mx-2 top-0`}
        >
          <button
